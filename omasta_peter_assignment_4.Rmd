...
Inside of this report, data collected from the Santa Barbara Channel Long Term Ecological Restoration Network (to be referred to as SBC LTER henceforth) is being used to look at how lobster populations have faired since the implementation of marine protected areas. The California Spiny Lobster (*Panulirus interruptus*) is considered one of the most important valuable aquatic species from an economic perspective, with an average annual price of $11.07 per pound, and earning over $3.3 million in earnings for the port of Santa Barbara in 2013. [Citation 1] Over harvesting of lobsters poses a threat to the stability of the ecosystem as well as the socioeconomic systems that have been created around the harvest of lobsters in Santa Barbara. [Citation 2] Marine Protected Areas prohibit the harvesting of lobsters within the boundary, and are associated with a resulting increase in the mean size and population density of losbters. [Citation 3] Research has also been performed that examines the importantance of spillover from marine protected areas into adjacent non-protected areas. It is theorized that spillover from protected areas which have larger populations may help to buoy the populations in non-protected areas by having adult lobsters move from the densely populated protected-habitats to less dense habitats in search of food.[Citation 2] This study will look at how the designation of two sites in the Santa Barbara Channel (Isla Vista and Naples) as mrine protected areas influenced the average size and population of the California Spiny Lobster from 2012 to 2018. 
...
Data was collected from the SBC LTER from 2012 - 2018, it is an on going study looking at multiple different ecological effects inside of the channel. The data looks at the collection and measurement of the California Spiny Lobster from five different study sites within the SBC LTER. Measurements included the size (in milimeters) of lobsters and population counts annually from 2012 until 2018. All of the analysis was performed in R (version 3.6.1), using the tidyverse, janitor, tidyr, plotly, and DT packages 
